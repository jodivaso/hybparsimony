...
*HYBparsimony* has predefined the most common scikit-learn algorithms as well as functions to measure their complexity and the hyperparameter ranges to search on. However, all this can be customized. 
