...
if __name__ == "__main__":
    ...
    # HYBparsimony_model = HYBparsimony(algorithm = 'LogisticRegression',
    #                                   features=breast_cancer.feature_names,
    #                                   # cv=RepeatedKFold(n_splits=5, n_repeats=10),
    #                                   rerank_error=0.01,
    #                                   # scoring='f1_macro',
    #                                   verbose=1)
    # HYBparsimony_model.fit(X_train, y_train, time_limit=0.30)
    # preds = HYBparsimony_model.predict_proba(X_test[:,HYBparsimony_model.selected_features_boolean])
    # print(f'\n\nBest Model = {HYBparsimony_model.best_model}')
    # print(f'Selected features:{HYBparsimony_model.selected_features}')
    # print(f'Complexity = {round(HYBparsimony_model.best_complexity, 2):,}')
    # print(f'5-CV logloss = {round(HYBparsimony_model.best_score,6)}')
    ...
    # print(f'5-CV f1_macro = {round(HYBparsimony_model.best_score,6)}')
